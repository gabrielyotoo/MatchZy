...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        private void HandleMatchStart()
        {
            ...
            {
                Server.PrintToChatAll($"{chatPrefix} {ChatColors.Default} Plugin by {ChatColors.Green}WD-{ChatColors.Default} | Modded by {ChatColors.DarkRed} yoto{ChatColors.Default}");
            }
